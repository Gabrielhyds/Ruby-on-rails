class MiningTypesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @mining_type.update(mining_type_params)
        format.html { redirect_to @mining_type, notice: "Mining type was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mining_types_path, notice: "Mining type was successfully destroyed.", status: :see_other }
